...
class EmptyStateTest extends PHPUnit_Framework_TestCase
{
	...
	{
		// ホワイトボックステストのみ
		UnityCrash\State\EmptyState::getInstance()->setup($context);
	}

	public function testLoop()
	{
		// ホワイトボックステストのみ
		UnityCrash\State\EmptyState::getInstance()->loop($context);
	}

	public function testTeardown()
	{
		// ホワイトボックステストのみ
		UnityCrash\State\EmptyState::getInstance()->teardown($context);
	}
